...
<body>
    <form action="#" class="container">
        <div class="homebutton">
            <a href="#"> <!--홈페이지넣기-->
                <img src="./resources/images/nav/Changwon PP logo1.png">
            </a>
        </div>

        <h1 class="idsearch">비밀번호찾기</h1><br><hr><br>


        <div class="tabmenu">
            <ul>
                <li id="tab1" class="btnCon">
                    <input type="radio" checked name="tabmenu" id="phonecheck" class="tabtab">
                    <label for="phonecheck" class="tab">휴대폰 번호로 찾기</label>
                    <div class="check">
                        <p>
                            <strong>아이디입력</strong> <br>
                            <input type="text" name="name" placeholder="아이디" class="name"> <br>
                ...
                <li id="tab1" class="btnCon">
                    <input type="radio" checked name="tabmenu" id="emailcheck" class="tabtab">
