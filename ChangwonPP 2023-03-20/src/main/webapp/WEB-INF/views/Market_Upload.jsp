...
<body>
   ...
   <div class="container">
      <article>
         ...
         <h1>플리:마켓 상품등록</h1>
         <br> <br>
         <form:form action="Market_Product" modelAttribute="Product" class="middle" method="post">
            <div>
                <img id="preview" /> <br><br>
                    <input type="file" id="imgfile" onchange="readURL(this);"> 
                    <label for="imgfile">
                    </label>
            </div>
            <br> <br>
            ...
            <div>
               <h2>상품상태</h2> <br> 
               <form:radiobutton  path="p_condition" /> 새상품 
               <form:radiobutton  path="p_condition" /> 중고상품
            </div>
            <br> <br>
            <div class="price">
               <h2>참고사항</h2>
